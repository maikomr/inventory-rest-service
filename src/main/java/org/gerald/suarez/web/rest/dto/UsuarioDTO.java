...
public class UsuarioDTO implements Serializable {
    ...
    public UsuarioDTO(Usuario usuario) {
        this(usuario.getLogin(), usuario.getRol(), usuario.getPermisos(), usuario.getEmpleado().getNombre(),
    ...
    public UsuarioDTO(String login, String rol, Set<Permiso> permisos, String nombre, String apellidoPaterno,
